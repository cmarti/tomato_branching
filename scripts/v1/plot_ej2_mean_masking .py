...
if __name__ == '__main__':
    ...
    axes.legend(loc=(0., 1.02), fontsize=8, title='Locus', ncols=3)
    axes.grid(alpha=0.2)

    fig.tight_layout()
    fig.savefig('plots/masking_js_means.{}.png'.format(model_label), dpi=300)
    fig.savefig('plots/masking_js_means.{}.pdf'.format(model_label), dpi=300)
